...
function submitHandle(event){
  ...
  axios({
    ...
    return(
      ...
      <Button variant="outline-success" onClick={<ViewProduct/>} href="/product">Search</Button>
    </Form>
    <br></br>
    <Form inline>
      ...
      <h5><Nav.Link href="/products/product">click here to view Products</Nav.Link></h5>
